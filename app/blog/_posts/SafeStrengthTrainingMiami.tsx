...
export default function SafeStrengthTrainingMiamiBody() {
  return (
    <div className="prose-custom">
      ...
      <h2>The problem with fixed resistance</h2>
      <p>
      ...
      <h2>What the evidence shows on safety</h2>
      <p>
      ...
      <h2>What a session looks like here</h2>
      <p>
      ...
      <h2>Practical points worth remembering</h2>
      <p>
