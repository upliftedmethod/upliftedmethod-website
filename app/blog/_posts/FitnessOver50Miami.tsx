...
/**
 * Post: Fitness Over 50 in Miami: Staying Strong and Capable
 */
export default function FitnessOver50MiamiBody() {
  return (
    <div className="prose-custom">
      ...
      <h2>Why muscle and strength change after 50</h2>
      <p>
      ...
      <h2>Joint health and daily capability</h2>
      <p>
      ...
      <h2>Where this fits in Miami</h2>
      <p>
      ...
      <h2>Sources</h2>
      <ul>
        <li>How can strength training build healthier bodies as we age? National Institute on Aging. June 30, 2022. https://www.nia.nih.gov/news/how-can-strength-training-build-healthier-bodies-we-age</li>
        <li>Moderate amount of strength training each week could boost longevity. Harvard T.H. Chan School of Public Health. June 9, 2026. https://hsph.harvard.edu/news/moderate-amount-of-strength-training-each-week-could-boost-longevity/</li>
        <li>The benefits of strength training for older adults. Rebecca Seguin et al. American Journal of Preventive Medicine. October 2003. https://pubmed.ncbi.nlm.nih.gov/14552938/</li>
        <li>Growing Stronger: Strength Training for Older Adults. Centers for Disease Control and Prevention. Program guide developed from Tufts University research.</li>
      </ul>
    </div>
  );
}
