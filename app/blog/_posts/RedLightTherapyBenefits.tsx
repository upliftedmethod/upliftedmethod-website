...
/**
 * Post: Red light therapy benefits & recovery (~1,200–1,500 words)
 * Keywords: red light therapy benefits, red light therapy for muscle recovery, how does red light therapy work.
 */
export default function RedLightTherapyBenefitsBody() {
  return (
    <div className="prose-custom">
      ...
      <h2>Red light therapy benefits: what the research suggests</h2>
      <p>
      ...
      <p>
        You’ll lie or sit in front of (or under) LED panels or a full-body bed. The lights are on; you relax. No heat to speak of, no pain. Session length is usually 10–20 minutes depending on the device and protocol. At our studio we use a full-body EnergyLounger and run about 20 minutes. You can do red light only or add it before or after <Link href="/arx" className="font-medium text-primary hover:underline">ARX</Link> or Shiftwave. Same visit, same place.
      </p>
