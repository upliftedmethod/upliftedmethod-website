...
/**
 * Post: Shiftwave recovery (~1,200–1,500 words)
 * Keywords: Shiftwave recovery, recovery studio Miami.
 */
export default function ShiftwaveRecoveryBody() {
  return (
    <div className="prose-custom">
      ...
      <h2>Why recovery studios use it</h2>
      <p>
      ...
      <h2>How a Shiftwave session works</h2>
      <p>
      ...
      <h2>Shiftwave and the rest of your routine</h2>
      <p>
