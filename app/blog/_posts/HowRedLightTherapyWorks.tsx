...
export default function HowRedLightTherapyWorksBody() {
  return (
    <div className="prose-custom">
      ...
      <h2>What happens when the light reaches your cells</h2>
      <p>
      ...
      <h2>Why the exact wavelengths matter</h2>
      <p>
      ...
      <h2>What the research shows for recovery after training</h2>
      <p>
      ...
      <h2>Timing and frequency that fit real life</h2>
      <p>
