...
/**
 * Post: Red light therapy in Miami (~1,200–1,500 words)
 * Keywords: best red light therapy Miami, red light therapy Miami.
 */
export default function RedLightTherapyMiamiBody() {
  return (
    <div className="prose-custom">
      ...
      <h2>What to expect from red light therapy in Miami</h2>
      <p>
