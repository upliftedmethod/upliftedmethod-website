    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-16">
      ...
      <section className="mt-12">
        ...
        <p className="mt-2 text-neutral-600">
          We build each session around what you need.
        </p>
      ...
      <section className="mt-12">
        ...
        <p className="mt-2 text-neutral-600">
          People come when the usual gym or cookie-cutter personal training isn&apos;t cutting it.
        </p>
        <ul className="mt-4 list-inside list-disc space-y-2 text-neutral-600">
      ...
      <section className="mt-12">
        ...
        <ul className="mt-4 list-inside list-disc space-y-2 text-neutral-600">
          <li><strong>Studio-first, no distractions.</strong> ARX and red light in one place at Upper Buena Vista. No big gym, no driving between spots.</li>
          <li><strong>Real equipment, real coaching.</strong> ARX Alpha and ARX Omni are the tools; our coaches make sure you use them right and progress. In-studio ARX, done right.</li>
          <li><strong>Built for busy adults.</strong> Our clients value time. Twenty minutes and a central location—Key Biscayne, Grove, Gables, Pinecrest, Beach, Surfside are all within reach.</li>
          <li><strong>Integrity over hype.</strong> We don&apos;t overpromise. Efficient strength, clear programming, and the option to add recovery. Results without the noise.</li>
        </ul>
      </section>
