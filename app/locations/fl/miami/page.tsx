...
export const metadata: Metadata = {
  ...
  description:
    "Uplifted studio at Upper Buena Vista, Miami. ARX, red light, recovery. Wynwood, Midtown, Edgewater, Brickell, Key Biscayne, Coconut Grove, Coral Gables, Pinecrest, Miami Beach, Surfside.",
  alternates: { canonical: "/locations/fl/miami" },
};
...
const AREAS = [
  ...
  { slug: "wynwood", name: "Wynwood", note: "Minutes from Wynwood. ARX, red light, Shiftwave—same neighborhood vibe." },
  { slug: "midtown", name: "Midtown", note: "Midtown to UBV—short drive. ARX, red light, Shiftwave." },
  { slug: "edgewater", name: "Edgewater", note: "Edgewater to UBV—Biscayne to our door in under fifteen." },
  { slug: "brickell", name: "Brickell", note: "Brickell to UBV—fifteen to twenty minutes. ARX, red light, Shiftwave." },
];

const MIAMI_LIST_BASE = "/locations/fl/miami";

export default function MiamiLocationsPage() {
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-16">
      ...
      <p id="miami" className="mt-4 text-lg text-neutral-600">
        We&apos;re at Upper Buena Vista. Clients drive in from the Key, Grove, Gables, Pinecrest, Beach, Surfside, Bay Point, Morningside, Miami Shores, Wynwood, Midtown, Edgewater, Brickell—and across Miami.
      </p>
      ...
      <ul className="mt-6 space-y-6">
        {AREAS.map((area) => (
          <li key={area.slug} id={area.slug} className="scroll-mt-24 border-b border-neutral-100 pb-6 last:border-0">
            <Link href={`${MIAMI_LIST_BASE}/${area.slug}`} className="group block">
